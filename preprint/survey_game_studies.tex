...
Die Regeln der Sagbarkeit eines Diskurses und somit einer Disziplin, auch im wissenschaftlichen Sinne, funktionieren also als soziokulturelle und diskursive Praxis durch das Zusammenspiel von formalen, sozialen, internen, externen und materiellen Regeln und sind somit dem Spiel ähnlich -- oder zumindest als spielförmig erfassbar --,\footnote{\autocite[Vgl.][S.~2--3]{stenros_rule_2024}; \autocite[][S.~24--325]{unterhuber_spielgeschichten_2025}} selbst wenn nicht alle Beteiligten, abhängig von z.\,B. ihrem Status, den gleichen Regeln unterliegen.
Zu einer ähnlichen Anschauung kommt Daniel Wrana, wenn er den Widerstreit verschiedener Disziplinen \enquote{im Terrain des \enquote{eigentlichen} wissenschaftlichen Spiels} um \enquote{Methodologien und um intellektuelle Techniken} untersucht:\autocite[][S.~49]{wrana_inter-disziplinaritat_2017}
...
Diese \enquote{Erkenntnispolitik}\footnote{\autocite[][S.~115--121]{seitter_erkenntnispolitik_1985}; \autocite[][S.~45]{wrana_inter-disziplinaritat_2017}.} zeigt zudem auf, dass sich eine Trennung zwischen diesen Aushandlungen und der \enquote{eigentliche[n] wissenschaftlich-fachliche[n] Debatte [$\ldots$] kaum halten} lässt:\autocite[][S.~49]{wrana_inter-disziplinaritat_2017}
...
Wie bereits Pierre Bourdieu formuliert, besitzen wissenschaftliche Felder \enquote{Gesetze der (materiellen wie symbolischen) \textit{Preisbildung}}, deren Aufgabe es ist, \enquote{die kognitiven Normen, denen sich die Wissenschaftler beim Nachweis der Gültigkeit ihrer Aussagen wohl oder übel beugen müssen, praktisch durchzusetzen}.\footnote{\autocite[][S.~89]{bourdieu_fur_1998}; Hervorhebung im Original.}
Diese Durchsetzung, die \enquote{ohne normative Anordnung und zumeist mit Hilfe der Dispositionen eines nach und nach auf ihre Notwendigkeit abgestimmten Habitus} funktioniert,\autocite[][S.~89]{bourdieu_fur_1998} kann als \enquote*{Wille zur Macht} des Feldes oder der Disziplin beschrieben werden.
Dieser muss sich dabei \enquote{der spezifischen Zensur des Felds} beugen, um in einem \enquote*{Willen zum Wissen} aufzugehen,\autocite[][S.~90]{bourdieu_fur_1998} was wohl umso mehr zutrifft, wenn die Interessen einer Disziplin auf ein neues Forschungsfeld oder eine Disziplin \textit{in statu nascendi} treffen.
...
\begin{quote}
   ...
   Umgekehrt ist eine Neuerung, die die jeweilige Bezugsgruppe für \enquote{völlig abwegig} erklärt, vorläufig so gut wie tot.\autocite[][S.~311]{toulmin_kritik_1978}
\end{quote}

Eine neue Idee, ein neues Forschungsfeld oder ein neuer Forschungszweig kann sich eben nicht allein durch Vernünftigkeit, Nachvollziehbarkeit oder Argumente durchsetzen,\autocite[Vgl.][S.~311]{toulmin_kritik_1978} sondern sie brauchen Autorität,\autocite[Vgl.][S.~308]{toulmin_kritik_1978} die im Wissenschaftsbetrieb vor allem über Karrierestufen bemessen wird.\autocite[Vgl.][S.~312]{toulmin_kritik_1978}
