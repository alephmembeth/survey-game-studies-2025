...
Erwähnenswert ist auch, dass sich nur wenige der genannten Ansätze genuin auf Spiele beziehen -- so wurde etwa \enquote{Game Analysis} nur ein einziges Mal genannt.\footnote{Entsprechend wurden auch keine methodischen Einführungen wie z.\,B. jene von Clara Fernandéz-Vara erwähnt (\autocite[vgl.][]{fernandez-vara_introduction_2024}).}
